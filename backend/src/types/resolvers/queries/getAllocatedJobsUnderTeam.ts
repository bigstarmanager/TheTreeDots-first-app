...
*/
export const getAllocatedJobsUnderTeam = queryField((t) => {
  t.field('getAllocatedJobsUnderTeam', {
    type: 'TlJobList',
    args: {
      ...
      const where = {
        ...
        TlServices: {
          some: {
            ...
            // in other words, collection and delivery task is allocated, test Commit.
            tl_service_type_id: {
              in: [1, 4]
            }
          }
