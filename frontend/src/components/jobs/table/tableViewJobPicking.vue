      ...
      <template v-slot:body="props">
        <slot name="loading">
          <q-tr :props="props">
            ...
            <q-td key="quantityToPick" :props="props">
              <span>{{ props.row.quantity }}</span>
            </q-td>
            <q-td key="quantityPicked" :props="props">
...
<script>
import { viewPickingColumns, fieldAssign } from 'src/constants/jobs';
...
export default {
  ...
  data() {
    return {
      icon_send,
      columnsAssign: [...viewPickingColumns, fieldAssign],
